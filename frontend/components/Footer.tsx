        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/zh/diving-experience" className="text-gray-400 hover:text-[#008ECC] transition-colors duration-300 flex items-center gap-2 group">
                  <span className="opacity-0 group-hover:opacity-100 transition-opacity">→</span>
                  潜水体验
                </Link>
              </li>
              <li>
                <Link href="/zh/diving-courses" className="text-gray-400 hover:text-[#008ECC] transition-colors duration-300 flex items-center gap-2 group">
                  <span className="opacity-0 group-hover:opacity-100 transition-opacity">→</span>
                  潜水课程
                </Link>
              </li>
              <li>
                <Link href="/zh/diving-travel" className="text-gray-400 hover:text-[#008ECC] transition-colors duration-300 flex items-center gap-2 group">
                  <span className="opacity-0 group-hover:opacity-100 transition-opacity">→</span>
                  潜水旅行
                </Link>
              </li>
              <li>
                <Link href="/zh/destinations" className="text-gray-400 hover:text-[#008ECC] transition-colors duration-300 flex items-center gap-2 group">
                  <span className="opacity-0 group-hover:opacity-100 transition-opacity">→</span>
                  潜水目的地
                </Link>
              </li>
              <li>
                <Link href="/zh/about" className="text-gray-400 hover:text-[#008ECC] transition-colors duration-300 flex items-center gap-2 group">
                  <span className="opacity-0 group-hover:opacity-100 transition-opacity">→</span>
                  关于我们
                </Link>
              </li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-500 text-center md:text-left text-sm">
              © 2024 奉旨潜水 - 官方网站 | All Rights Reserved
            </p>
            <div className="flex items-center space-x-2 text-gray-500 text-sm">
              <span>PADI 国际认证潜水中心</span>
            </div>
          </div>
        </div>
      </div>
