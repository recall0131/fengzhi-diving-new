...
function getToken(){return localStorage.getItem('admin_token');}
function init(){var t=getToken();if(!t){window.location.href='/admin/login';return;}var u=localStorage.getItem('admin_user');if(u)document.getElementById('userEmail').textContent=JSON.parse(u).email;init();}
